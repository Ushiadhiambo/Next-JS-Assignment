...
export default function FlashSalePage() {
    ...
    const products = [ {id: 1, name: "HAVIT HV-G92 Gamepad",price: 120,originalPrice: 200,discount: 40,rating: 5,reviews: 88,image: "/images/Frame 611.png" },
        { id: 2, name: "AK-900 Wired Keyboard", price: 960, originalPrice: 1160, discount: 35, rating: 4, reviews: 75, image: "/images/image.png"},
        {id: 3, name: "IPS LCD Gaming Monitor", price: 370, originalPrice: 400, discount: 30, rating: 5, reviews: 99, image: "/images/image copy.png"},
        {id: 4,name: "S-Series Comfort Chair",price: 375,originalPrice: 400,discount: 25,rating: 4,reviews: 99,image: "/images/image copy 2.png" },
    ];
                ...
                {getCurrentProducts().map((product) => (
                    <div key={product.id} className="group cursor-pointer">
                        <div className="relative bg-gray-200 rounded-sm p-8 mb-4 h-64 flex items-center justify-center">
                            ...
                            <div className="w-55 h-65 rounded-lg flex items-center justify-center overflow-hidden">
                                <Image
                                    src={product.image}
                                    alt={product.name}
                                    width={150}
