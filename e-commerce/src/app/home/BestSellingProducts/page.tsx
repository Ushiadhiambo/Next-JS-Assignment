...
export default function BestSelling() {
  const products = [
    {id: 1,name: "The north coat",price: 260,originalPrice: 360,rating: 5,reviews: 65, Image: "/images/image copy 3.png" },
    {id: 2,name: "Gucci duffle bag",price: 960,originalPrice: 1160,rating: 4,reviews: 65,Image: "/images/image copy 4.png" },
    {id: 3,name: "RGB liquid CPU Cooler",price: 160,originalPrice: 170,rating: 4,reviews: 65,Image: "/images/image copy 5.png" },
    {id: 4,name: "Small BookSelf",price: 360,originalPrice: null,rating: 5,reviews: 65,Image: "/images/image copy 6.png" }
  ];
